...
namespace sdl_lazyfoo
{
  namespace lesson3
  {
    ...
    bool init()
    {
      ...
      {
        window = SDL_CreateWindow("SDL Tutorial Lesson 2", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
        if (window == nullptr)
        {
    ...
    bool loadMedia()
    {
      ...
      lenna_surface = SDL_LoadBMP("images/02-lenna.bmp");
