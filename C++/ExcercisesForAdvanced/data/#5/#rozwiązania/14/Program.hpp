...
private:
  bool pauza = false;
  unsigned long long int pauzaPoMilisekundach = 0;  // po ile milisekundach Pauza
...
public:
  ...
  // dodawanie funkcji wykonujących progres obiektów (zmiany stanów, np. ruch, pozycję, wielkości itp.)
